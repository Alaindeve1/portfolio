  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'grid-pattern-dark': "url(" + "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='32' height='32' fill='none' stroke='rgb(30 41 59 / 0.1)'%3e%3cpath d='M0 .5H31.5V32'/%3e%3c/svg%3e" + ")",
      },
      boxShadow: {
        'glow': '0 0 15px rgba(99, 102, 241, 0.2)',
        'glow-md': '0 0 30px rgba(99, 102, 241, 0.15)',
        'glow-lg': '0 0 60px rgba(99, 102, 241, 0.1)',
